...
const SCENES: readonly { id: string; query: string; view?: keyof typeof VIEWPORTS }[] = [
  ...
  { id: 'chosen-hant', query: 'lang=zh-Hant&chosen=1' },
  { id: 'chosen-es', query: 'lang=es-MX&chosen=1' },
  { id: 'typed', query: 'buffer=Alva' },
  { id: 'typed-chosen-hans', query: 'lang=zh-Hans&chosen=1&buffer=Ts' },
  { id: 'nomatch-voices', query: 'buffer=Zzz&nomatch=1' },
  { id: 'nomatch-chosen-es', query: 'lang=es-MX&chosen=1&buffer=Zzz&nomatch=1' },
