    ...
    <PageFrame width="2xl">
      ...
      */}
      ...
      {/*
        ...
        always below the fold: a leader deciding whether to phone a family read
        the contact card, then scrolled past it to find out whether there was
        anything to phone about. Side by side the decision is one screen.

        Profile keeps the measure it was laid out at and Attendance takes the
        rest, because the history grid is the half that grows with the window.
        `items-start` so the shorter card stops where it ends.
      */}
