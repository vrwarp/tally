...
function EventRow({
  ...
  // Admin-only, and only where there is a fence. See `NarrowedBadge`.
  const narrowed = useNarrowedCount(event);

  const badges = [
    narrowed !== null ? <NarrowedBadge key="narrowed" count={narrowed} /> : null,
