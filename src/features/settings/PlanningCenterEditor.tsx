...
const WRITE_BACK_HINT: Record<PcoWriteBackMode, string> = {
  ...
  full: 'Tally creates people, and Edit profile becomes editable for students Planning Center already has — first name, last name, grade and medical notes are saved there. A leader can also add a parent contact to an adult already in the household. It never creates a parent or a household, and never overwrites a number on file.',
};
