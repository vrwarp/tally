...
const WRITE_BACK_LABEL: Record<PcoWriteBackMode, string> = {
  ...
  full: 'Tally creates people, and Edit profile saves a linked student’s name, grade and allergies straight to Planning Center. It can also add a parent contact to an adult already in a household.',
};
