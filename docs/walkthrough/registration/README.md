...
### 7. Ticked, and the box goes quiet
...
![Ticked, and the box goes quiet — landscape](shots/landscape-07-ticked-and-the-box-goes-quiet.png)

<img src="shots/portrait-07-ticked-and-the-box-goes-quiet.png" width="320" alt="Ticked, and the box goes quiet — portrait">
...
![Anybody else? — landscape](shots/landscape-08-anybody-else.png)

<img src="shots/portrait-08-anybody-else.png" width="320" alt="Anybody else? — portrait">

### 9. The surname, carried
...
![The surname, carried — landscape](shots/landscape-09-the-surname-carried.png)

<img src="shots/portrait-09-the-surname-carried.png" width="320" alt="The surname, carried — portrait">

### 10. Both of them, named

*Two children*

The same fork one child later. Nothing about this screen asks a parent to remember anything.

![Both of them, named — landscape](shots/landscape-10-both-of-them-named.png)

<img src="shots/portrait-10-both-of-them-named.png" width="320" alt="Both of them, named — portrait">

### 11. A dialer, for the one question that is a number
...
![A dialer, for the one question that is a number — landscape](shots/landscape-11-a-dialer-for-the-one-question-that-is-a-number.png)

<img src="shots/portrait-11-a-dialer-for-the-one-question-that-is-a-number.png" width="320" alt="A dialer, for the one question that is a number — portrait">
...
![Ten digits — landscape](shots/landscape-12-ten-digits.png)

<img src="shots/portrait-12-ten-digits.png" width="320" alt="Ten digits — portrait">
...
![Does this look right? — landscape](shots/landscape-13-does-this-look-right.png)

<img src="shots/portrait-13-does-this-look-right.png" width="320" alt="Does this look right? — portrait">

### 14. Next time, just type those four digits
...
![Next time, just type those four digits — landscape](shots/landscape-14-next-time-just-type-those-four-digits.png)

<img src="shots/portrait-14-next-time-just-type-those-four-digits.png" width="320" alt="Next time, just type those four digits — portrait">

### 15. And it works immediately
...
![And it works immediately — landscape](shots/landscape-15-and-it-works-immediately.png)

<img src="shots/portrait-15-and-it-works-immediately.png" width="320" alt="And it works immediately — portrait">

## The second child

### 16. The other door, in the same slot
...
![The other door, in the same slot — landscape](shots/landscape-16-the-other-door-in-the-same-slot.png)

<img src="shots/portrait-16-the-other-door-in-the-same-slot.png" width="320" alt="The other door, in the same slot — portrait">

### 17. The cheaper answer, offered first
...
![The cheaper answer, offered first — landscape](shots/landscape-17-the-cheaper-answer-offered-first.png)

<img src="shots/portrait-17-the-cheaper-answer-offered-first.png" width="320" alt="The cheaper answer, offered first — portrait">

### 18. Joining the family that exists
...
![Joining the family that exists — landscape](shots/landscape-18-joining-the-family-that-exists.png)

<img src="shots/portrait-18-joining-the-family-that-exists.png" width="320" alt="Joining the family that exists — portrait">

### 19. Recorded, not decided
...
![Recorded, not decided — landscape](shots/landscape-19-recorded-not-decided.png)

<img src="shots/portrait-19-recorded-not-decided.png" width="320" alt="Recorded, not decided — portrait">
