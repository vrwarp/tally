...
### 25. The ones who came in together
...
![The ones who came in together — wide](shots/wide-25-the-ones-who-came-in-together.png)

<img src="shots/tall-25-the-ones-who-came-in-together.png" width="320" alt="The ones who came in together — tall">

### 26. And she is one tap away, because families do
...
![And she is one tap away, because families do — wide](shots/wide-26-and-she-is-one-tap-away-because-families-do.png)

<img src="shots/tall-26-and-she-is-one-tap-away-because-families-do.png" width="320" alt="And she is one tap away, because families do — tall">

### 27. Three seconds, once, for the whole family
...
![Three seconds, once, for the whole family — wide](shots/wide-27-three-seconds-once-for-the-whole-family.png)

<img src="shots/tall-27-three-seconds-once-for-the-whole-family.png" width="320" alt="Three seconds, once, for the whole family — tall">

## Act 6 — The review

### 28. The door records; a person decides
...
![The door records; a person decides — wide](shots/wide-28-the-door-records-a-person-decides.png)

<img src="shots/tall-28-the-door-records-a-person-decides.png" width="320" alt="The door records; a person decides — tall">

### 29. The form as the family typed it
...
![The form as the family typed it — wide](shots/wide-29-the-form-as-the-family-typed-it.png)

<img src="shots/tall-29-the-form-as-the-family-typed-it.png" width="320" alt="The form as the family typed it — tall">

### 30. This might be the Jacob Smith we already have
...
![This might be the Jacob Smith we already have — wide](shots/wide-30-this-might-be-the-jacob-smith-we-already-have.png)

<img src="shots/tall-30-this-might-be-the-jacob-smith-we-already-have.png" width="320" alt="This might be the Jacob Smith we already have — tall">

### 31. Approval is a replay, in the right order
...
![Approval is a replay, in the right order — wide](shots/wide-31-approval-is-a-replay-in-the-right-order.png)

<img src="shots/tall-31-approval-is-a-replay-in-the-right-order.png" width="320" alt="Approval is a replay, in the right order — tall">

### 32. And the other answer
...
![And the other answer — wide](shots/wide-32-and-the-other-answer.png)

<img src="shots/tall-32-and-the-other-answer.png" width="320" alt="And the other answer — tall">

## Act 7 — The rest of the week

### 33. The same job, without a kiosk
...
![The same job, without a kiosk — wide](shots/wide-33-the-same-job-without-a-kiosk.png)

<img src="shots/tall-33-the-same-job-without-a-kiosk.png" width="320" alt="The same job, without a kiosk — tall">

### 34. One student, and the history under them
...
![One student, and the history under them — wide](shots/wide-34-one-student-and-the-history-under-them.png)

<img src="shots/tall-34-one-student-and-the-history-under-them.png" width="320" alt="One student, and the history under them — tall">

### 35. A call list, not a report
...
![A call list, not a report — wide](shots/wide-35-a-call-list-not-a-report.png)

<img src="shots/tall-35-a-call-list-not-a-report.png" width="320" alt="A call list, not a report — tall">

### 36. Where the church's database is connected
...
![Where the church's database is connected — wide](shots/wide-36-where-the-church-s-database-is-connected.png)

<img src="shots/tall-36-where-the-church-s-database-is-connected.png" width="320" alt="Where the church's database is connected — tall">

### 37. How the lobby screen gets its identity
...
![How the lobby screen gets its identity — wide](shots/wide-37-how-the-lobby-screen-gets-its-identity.png)

<img src="shots/tall-37-how-the-lobby-screen-gets-its-identity.png" width="320" alt="How the lobby screen gets its identity — tall">
