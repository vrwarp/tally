...
### 46. Half a number is not a failed search
...
![Half a number is not a failed search — wide](shots/wide-46-half-a-number-is-not-a-failed-search.png)

<img src="shots/tall-46-half-a-number-is-not-a-failed-search.png" width="320" alt="Half a number is not a failed search — tall">

### 47. The wifi went, and the screen says so once
...
![The wifi went, and the screen says so once — wide](shots/wide-47-the-wifi-went-and-the-screen-says-so-once.png)

<img src="shots/tall-47-the-wifi-went-and-the-screen-says-so-once.png" width="320" alt="The wifi went, and the screen says so once — tall">

### 48. One word, and the whole sweep behind it
...
![One word, and the whole sweep behind it — wide](shots/wide-48-one-word-and-the-whole-sweep-behind-it.png)

<img src="shots/tall-48-one-word-and-the-whole-sweep-behind-it.png" width="320" alt="One word, and the whole sweep behind it — tall">

### 49. No QR, and the other door is right there

*A family with a phone and no code to scan*
...
![No QR, and the other door is right there — wide](shots/wide-49-no-qr-and-the-other-door-is-right-there.png)

<img src="shots/tall-49-no-qr-and-the-other-door-is-right-there.png" width="320" alt="No QR, and the other door is right there — tall">

### 50. A code that is no longer a door
...
![A code that is no longer a door — wide](shots/wide-50-a-code-that-is-no-longer-a-door.png)

<img src="shots/tall-50-a-code-that-is-no-longer-a-door.png" width="320" alt="A code that is no longer a door — tall">

### 51. The one field with a rule beyond “not empty”

*A parent going too fast*
...
![The one field with a rule beyond “not empty” — wide](shots/wide-51-the-one-field-with-a-rule-beyond-not-empty.png)

<img src="shots/tall-51-the-one-field-with-a-rule-beyond-not-empty.png" width="320" alt="The one field with a rule beyond “not empty” — tall">

### 52. Tapped twice, counted once
...
![Tapped twice, counted once — wide](shots/wide-52-tapped-twice-counted-once.png)

<img src="shots/tall-52-tapped-twice-counted-once.png" width="320" alt="Tapped twice, counted once — tall">

### 53. The doors have shut, and it still works
...
![The doors have shut, and it still works — wide](shots/wide-53-the-doors-have-shut-and-it-still-works.png)

<img src="shots/tall-53-the-doors-have-shut-and-it-still-works.png" width="320" alt="The doors have shut, and it still works — tall">
